...
export type UserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"nickname" | "email" | "password", ExtArgs["result"]["user"]>
...
export interface UserDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Users and only return the `nickname`
   * const userWithNicknameOnly = await prisma.user.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Users and only return the `nickname`
   * const userWithNicknameOnly = await prisma.user.updateManyAndReturn({
   *   select: { nickname: true },
   *   where: {
   *     // ... provide filter here
   *   },
